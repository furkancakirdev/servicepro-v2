...
export const serviceCategoriesSeed: ServiceCategorySeed[] = [
  ...
  { name: "Isıtma / klima", subScope: "Bakim ve filtre", multiplier: 1.0, brandHints: "Webasto" },
  { name: "Isıtma / klima", subScope: "Ariza / kurulum", multiplier: 2.0, brandHints: "Webasto" },
