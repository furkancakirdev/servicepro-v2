...
export const serviceCategoriesSeed: ServiceCategorySeed[] = [
  ...
  { name: "Isitma / klima", subScope: "Bakim ve filtre", multiplier: 1.0, brandHints: "Webasto" },
  { name: "Isitma / klima", subScope: "Ariza / kurulum", multiplier: 2.0, brandHints: "Webasto" },
