        ...
        {statCards.map((card) => {
          ...
          return (
            <Link key={card.title} href={card.href} className="block">
              <Card className="border-white/80 bg-white/95 transition-transform hover:-translate-y-0.5 hover:border-marine-ocean/30">
                <CardHeader className="space-y-3">
                  ...
                  <div>
                    ...
                    <CardTitle className="mt-1 text-2xl text-marine-navy">{card.value}</CardTitle>
                  </div>
                </CardHeader>
              </Card>
            </Link>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-white/80 bg-white/95">
            <CardHeader>
              ...
              <CardDescription>
                Aktif is emirleri lokasyona gore gruplanmistir.
              </CardDescription>
            </CardHeader>
                ...
                dashboard.myJobs.map((group) => (
                  ...
                  >
                    <div className="mb-3 flex items-center justify-between gap-3">
                      <div>
                        <div className="text-sm font-semibold text-marine-navy">{group.location}</div>
                    ...
                    <div className="space-y-3">
                      {group.jobs.map((job) => (
                        ...
                        >
                          ...
                          <div className="text-xs uppercase tracking-[0.12em] text-slate-500">
                            {job.timeLabel} operasyon referansi
                          </div>
                        </Link>
                      ))}
                    </div>
        ...
        <div className="space-y-6">
          <Card className="border-white/80 bg-white/95">
            <CardHeader>
              ...
              <CardDescription>
                Kayit, tamamlama ve kapanis hareketlerinin gunluk ritmi.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-white/80 bg-white/95">
            <CardHeader>
              ...
              <CardDescription>Aylik toplam puana gore mini siralama.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="truncate font-medium text-marine-navy">{entry.user.name}</div>
                    ...
                    <div className="text-right">
                      <div className="font-semibold text-marine-navy">{entry.total.toFixed(1)}</div>
                      <div className="text-xs text-slate-500">{entry.badges.length} rozet</div>
                    </div>
                  </Link>
                ))
              ) : (
